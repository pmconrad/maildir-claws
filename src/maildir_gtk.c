...
void maildir_gtk_init(void)
{
	...
	gtk_action_group_add_actions(mainwin->action_group, mainwindow_add_mailbox,
			1, (gpointer)mainwin);
	MENUITEM_ADDUI_ID_MANAGER(mainwin->ui_manager, "/Menu/File/AddMailbox", "Maildir", 
			  "File/AddMailbox/Maildir", GTK_UI_MANAGER_MENUITEM,
			  main_menu_id)
}
...
static void add_menuitems(GtkUIManager *ui_manager, FolderItem *item)
{
	...
	MENUITEM_ADDUI_MANAGER(ui_manager, "/Popup/FolderViewPopup", "SeparatorMaildir1", "FolderViewPopup/---", GTK_UI_MANAGER_SEPARATOR)
	...
	MENUITEM_ADDUI_MANAGER(ui_manager, "/Popup/FolderViewPopup", "SeparatorMaildir2", "FolderViewPopup/---", GTK_UI_MANAGER_SEPARATOR)
	...
	MENUITEM_ADDUI_MANAGER(ui_manager, "/Popup/FolderViewPopup", "SeparatorMaildir3", "FolderViewPopup/---", GTK_UI_MANAGER_SEPARATOR)
	...
	MENUITEM_ADDUI_MANAGER(ui_manager, "/Popup/FolderViewPopup", "SeparatorMaildir4", "FolderViewPopup/---", GTK_UI_MANAGER_SEPARATOR)
	...
	MENUITEM_ADDUI_MANAGER(ui_manager, "/Popup/FolderViewPopup", "SeparatorMaildir5", "FolderViewPopup/---", GTK_UI_MANAGER_SEPARATOR)
}
